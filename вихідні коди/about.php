...
<head>
    ...
    <title>SushiSloth - Про нас</title>
...
<header class="header">
    ...
    <main class="maina">
        <div class="container mt-5 pt-5">
            <h1 class="display-4" data-lang="about-us">Про нас</h1>
            <div class="row">
                <div class="col-md-6">
                    <p data-lang="intro1">Наш ресторан SushiSloth - це місце, де поєднуються традиції та сучасність. Ми пропонуємо широкий асортимент смачних суші, приготованих з найсвіжіших інгредієнтів. Наші шеф-кухарі мають багаторічний досвід та використовують тільки найкращі продукти, щоб ви могли насолоджуватися кожним шматочком.</p>
                    <p data-lang="intro2">Ми прагнемо створити незабутню атмосферу для наших гостей. Наша місія - забезпечити вам найкращий сервіс та задоволення від кожного візиту.</p>
                </div>
                <div class="col-md-6">
                    <img src="pics/about/photo2.jpg" alt="Modern Sushi Restaurant" class="img-fluid">
                </div>
            </div>
            <hr>
            <div class="row mt-5">
                <div class="col-md-6">
                    <img src="pics/about/photo1.jpg" alt="Happy Customers" class="img-fluid">
                </div>
                <div class="col-md-6">
                    <p data-lang="intro3">Ми створили сучасний та стильний інтер'єр, де ви зможете насолоджуватися не лише смачною їжею, а й приємною атмосферою. Наш ресторан ідеально підходить для романтичних побачень, зустрічей з друзями або сімейних свят.</p>
                    <p data-lang="intro4">Приєднуйтесь до нас у SushiSloth і відкрийте для себе справжній смак Японії в серці нашого міста!</p>
                </div>
            </div>
        </div>
    </main>
