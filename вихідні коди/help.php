...
<head>
    ...
    <title>SushiSloth - Допомога</title>
...
<header class="header">
    ...
    <main class="main">
        <div class="container mt-5 pt-5">
            <h1 class="display-4">Допомога</h1>
            <div class="row">
                <div class="col-md-6">
                    <h3>Як зробити замовлення?</h3>
                    <p>Щоб зробити замовлення, просто виберіть страви з нашого меню та додайте їх у кошик. Після цього перейдіть до кошика та заповніть необхідні дані для доставки та оплати.</p>
                </div>
                <div class="col-md-6">
                    <img src="pics/help/photo1.jpg" alt="Making an order" class="img-fluid">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-6">
                    <img src="pics/help/photo2.jpg" alt="Customer Support" class="img-fluid">
                </div>
                <div class="col-md-6">
                    <h3>Підтримка клієнтів</h3>
                    <p>Якщо у вас виникли питання або проблеми, ви можете звернутися до нашої служби підтримки клієнтів за телефоном +38 012 345 6789 або написати нам на email: support@sushisloth.ua. Ми завжди раді допомогти вам!</p>
                </div>
            </div>
        </div>
    </main>
